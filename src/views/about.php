...
<div class="container px-6 mt-28 flex justify-center items-center flex-1">
    <div class="flex flex-col-reverse lg:flex-row my-6">
        ...
        <div class="">
            <h1 class="flex items-center mb-6 text-sm font-bold text-orange-600 tracking-widest after:flex-1 after:ml-2 after:h-[1px] after:w-44 after:bg-main">A BIT ABOUT ME</h1>
            ...
            <ul class="py-6 flex flex-row flex-wrap">
                <li class="basis-1/2 md:basis-1/3">PHP Language</li>
                <li class="basis-1/2 md:basis-1/3">PHP Language</li>
                <li class="basis-1/2 md:basis-1/3">PHP Language</li>
                <li class="basis-1/2 md:basis-1/3">PHP Language</li>
                <li class="basis-1/2 md:basis-1/3">PHP Language</li>
