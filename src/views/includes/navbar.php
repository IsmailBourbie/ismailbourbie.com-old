<nav x-data="{ open: false }">
    ...
    <div class="fixed transform transition duration-500 inset-0 z-40 -translate-y-full bg-yellow-100 border-8 border-white pt-8 md:pt-20 pb-4" :class="{'translate-y-0': open}">
        <div class="container mx-auto h-full">
            <div class="flex flex-col justify-between h-full">
                ...
                <p class="translate-y-0 text-center border-t border-main text-main py-2 md:py-5 w-11/12 md:w-10/12 mx-auto mt-8" x-show="open" x-transition:enter.delay.300ms>© Ismail Bourbie 2022. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</nav>